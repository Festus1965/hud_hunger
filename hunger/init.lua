...
HUNGER_MOVE_TICK = 1.0		-- by Thomas
...
minetest.register_privilege("sarasas", {
    description = "Has no hunger",
    give_to_singleplayer = false,
})

minetest.register_privilege("lungma", {
    description = "Has no hunger",
    give_to_singleplayer = false,
})

minetest.register_privilege("kid", {
    description = "Has no hunger",
    give_to_singleplayer = false,
})

minetest.register_privilege("friend", {
    description = "Has no hunger",
    give_to_singleplayer = false,
})

minetest.register_privilege("parent", {
    description = "Has no hunger",
    give_to_singleplayer = false,
})


minetest.register_privilege("donate", {
    description = "Has no hunger",
    give_to_singleplayer = false,
})

minetest.register_privilege("food", {
    description = "Has less hunger",
    give_to_singleplayer = false,
})
...
-- from https://
print("[Mod] hud_hunger / hunger (?) - (" .. modcounter .. ") end with "..math.floor(collectgarbage("count")).." KB")
