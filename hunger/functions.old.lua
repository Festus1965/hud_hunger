...
--	by Thomas
--	hud.change_item("Thailand", "hunger", {number = 20})
--
...
function hunger.handle_node_actions(pos, oldnode, player, ext)
	...
	if exhaus > HUNGER_EXHAUST_LVL then
		...
		if h > 0 then
			...
			if name == "Siriphorn" or name == "Thailand" or name == "Thomas" or name == "Explorer" or name == "Celine" or name == "Cooking" then
--				print("line 100: "..name.." with ".. 20)
				update_hunger(player, 20)
			end
			if name == "Amun" or name == "Farsai" or name == "Chelsi" or name == "Juna" or name == "pat" or name == "Ann" or name == "ing" then
--				print("line 100: "..name.." with ".. 16)
				update_hunger(player, 20)
			end
			if name == "Sunday" or name == "Cameron" or name == "Chompuu" or name == "Bonat" or name == "Pond" or name == "Sea" or name == "Bella" or name == "Jasmin" then
--				print("line 100: "..name.." with ".. 18)
				update_hunger(player, 20)
			end
			if name == "paulabc" then
--				print("line 100: "..name.." with ".. 16)
				update_hunger(player, 20)
			end
		end
		...
		for _,player in ipairs(minetest.get_connected_players()) do
			...
			if tab then
				...
				if tonumber(tab.lvl) < HUNGER_STARVE_LVL then
					...
					if name == "Siriphorn" or name == "Thailand" or name == "Thomas" or name == "Explorer" or name == "Celine" then
					--	print("line 173: "..name.." with ".. 25)
						player:set_hp(25)
					end
				end
			end
